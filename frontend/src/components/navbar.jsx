...
import { House, FileUser, NotebookPen, Folder, Star, User, SearchIcon } from 'lucide-react'
const Navbar = ({ menuOpen, setMenuOpen }) => {
    ...
    return (
        ...
        <nav className="navbar" onClick={(e) => e.stopPropagation()}>
            <div className="logo">  <span id="heading">HIET</span></div>
            <div className="right">
                ...
                <NavLink className={({ isActive }) => `searchLink ${isActive ? 'active-link' : ""}`} to="/search"><SearchIcon className="navSearch navIcon" /><span>Search</span>  </NavLink>
